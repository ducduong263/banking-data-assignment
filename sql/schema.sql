...
CREATE TYPE enum_account_type AS ENUM ('payment', 'savings');
...
CREATE TYPE enum_auth_method AS ENUM ('password', 'pin', 'sms_otp','soft_otp', 'device_biometric','biometric_faceid');
